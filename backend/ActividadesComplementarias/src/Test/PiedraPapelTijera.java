...
public class PiedraPapelTijera {
	...
	public static void comenzarJuego() {
		...
		do {
		JOptionPane.showMessageDialog(null, "Este es el juego de Piedra, Papel y Tijera, tendrás que elegir una opción para jugar");
		jugador1 = JOptionPane.showInputDialog(null,"Tú eres el jugador 1, elige tu jugada entre piedra, papel y tijera");
		jugador2 = JOptionPane.showInputDialog(null,"Tú eres el jugador 2, elige tu jugada entre piedra, papel y tijera");
